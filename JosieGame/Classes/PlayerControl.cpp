...
void PlayerControl::addLevelControls()
{
	...
	_ljump = MenuItemImage::create("buttons/jump.png","buttons/jump.png", CC_CALLBACK_1(PlayerControl::jumpCallback, this));
...
void PlayerControl::addBossControls()
{
	...
	_bjump = MenuItemImage::create("buttons/jump.png","buttons/jump.png", CC_CALLBACK_1(PlayerControl::jumpCallback, this));
