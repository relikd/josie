...
\sectionOG{Klassenübersicht}\label{sec:3_Klassenuebersicht}
...
Wie bereits im Kapitel \ref{sec:3_Klassenuebersicht} erwähnt, stammen nicht alle Klassen von \cocosclass{Scene} bzw. \cocosclass{Layer} ab. Die Grafik \ref{collision_layer_derive} illustriert den Nutzen der \josieclass{CollisionLayer} Klasse.
