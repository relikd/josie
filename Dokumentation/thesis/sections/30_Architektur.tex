...
\begin{itemize}
\item Jump and Run Level

Der Spieler versucht ohne Zeiteinschränkung das Level abzuschließen und so viele Münzen wie möglich einzusammeln. Bei einem perfekten Lauf \textbf{kann} man alle Münzen einsammeln, einige davon sind allerding so plaziert dass sie nur schwer zu erreichen sind.
