...
Eine Erklärung für den Aufbau einer Animation durch ein Spritesheet und eine .plist Datei soll durch das folgende Beispiel erbracht werden. Hierbei wird ein Beispiel aus der \josieclass{LevelPlayer} genutzt. 
