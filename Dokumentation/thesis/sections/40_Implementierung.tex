...
Ein Erklärung für den Aufbau einer Animation durch ein Spritesheet und eine .plist Datei soll nun erbracht werden. Hierbei wird ein Beispiel aus der LevelPlayer Klasse genutzt. 
