...
\begin{figure}[H]
 \centering
  ...
  \caption{Bildliche Darstellung des Unterschieds zwischen MoveBy und MoveTo}
...
Für die Spielersteuerung (Kapitel \ref{sec:4_SpielerSteuerung} wird ein Observer Pattern verwendet.

 Siehe \cite{gamma2011patterns}
