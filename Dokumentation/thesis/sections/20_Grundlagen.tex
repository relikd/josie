...
\begin{figure}[H]
  \includegraphics[width=0.1\textwidth]{resources/josiedoku3}
...
\begin{figure}[H]
  \includegraphics[width=0.1\textwidth]{resources/josiedoku6}
  \label{fig:josie} 
\end{figure}
...
\begin{figure}[H]
  \includegraphics[width=0.1\textwidth]{resources/josiedoku5}
...
\begin{figure}[H]
  \includegraphics[width=0.1\textwidth]{resources/sequence}
...
\sectionOG{Callbackprinzip}\label{sec:2_Callbackprinzip}
